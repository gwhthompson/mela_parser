...
from mela_parser.converter import EpubConverter
from mela_parser.parse import CookbookParser, MelaRecipe
from mela_parser.recipe import RecipeProcessor
from mela_parser.image_processor import extract_images_for_recipe
...
def count_recipe_fields(recipe: MelaRecipe) -> int:
    ...
    if recipe.recipeYield and len(recipe.recipeYield.strip()) > 0:
        count += 1

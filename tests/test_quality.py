...
from mela_parser.parse import CookbookParser, MelaRecipe, IngredientGroup, Category
from scripts.main_overlap import (
    deduplicate_recipes,
    normalize_title,
    count_recipe_fields,
    is_recipe_complete,
...
class TestDeduplication:
    ...
    def test_keeps_most_complete_duplicate(self):
        ...
        assert kept.recipeYield == "Serves 8", "Should keep version with yield"
